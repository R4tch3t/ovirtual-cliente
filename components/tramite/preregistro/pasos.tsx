...
const PasosPreregistro:FC<Props> = ({paises}) => {
  const {tramitesState, dispatch} = useTramitesContext()
  const {planElegido, localidad, paso1, paso2, paso3, paso4, paso5} = tramitesState.procedimientos.preregistro!
  ...
  return (
    <div>
      ...
      <nav aria-label="Progress" className='preregSteps'>
