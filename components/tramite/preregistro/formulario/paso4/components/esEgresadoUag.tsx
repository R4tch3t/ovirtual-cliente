...
const EsEgresadoUag = () => {
    ...
    const {paso4} = tramitesState.procedimientos.preregistro!
    const naSelec = paso4 ? opciones?.find((op) => {
        return op.val === paso4.esEgresadoUag
    }) : undefined;
    ...
    query === ''
      ...
      const handleChange = (op:TypeOpciones) => {
        ...
        const nombreCampo='esEgresadoUag';
    ...
    return (
        ...
        <Combobox.Label className="block text-sm font-medium text-gray-700"><span className="mt-2 text-sm text-red-500">* </span>Eres Egresado UAGro?:  </Combobox.Label>
