...
const EsAfroGuerrerense = () => {
    ...
    query === ''
      ...
      const handleChange = (op:TypeOpciones) => {
        ...
        const nombreCampo='esAfroamericano';
    ...
    return (
        ...
        <Combobox.Label className="block text-sm font-medium text-gray-700"><span className="mt-2 text-sm text-red-500">* </span>Es Afromexicano Guerrerense?:  </Combobox.Label>
        ...
        {paso3?.esAfroamericano! === undefined &&  
