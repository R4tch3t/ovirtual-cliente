...
const EsResidenteSierra = () => {
    ...
    query === ''
      ...
      const handleChange = (op:TypeOpciones) => {
        ...
        const nombreCampo='esResidenteSierra';
    ...
    return (
        ...
        <Combobox.Label className="block text-sm font-medium text-gray-700"><span className="mt-2 text-sm text-red-500">* </span>Es residente de la Sierra de Guerrero?:  </Combobox.Label>
        ...
        {paso3?.esResidenteSierra! === undefined &&  
