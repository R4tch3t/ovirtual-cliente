...
const EsHijoMigrante = () => {
    ...
    query === ''
      ...
      const handleChange = (op:TypeOpciones) => {
        ...
        const nombreCampo='esHijoMigrante';
    ...
    return (
        ...
        <Combobox.Label className="block text-sm font-medium text-gray-700"><span className="mt-2 text-sm text-red-500">* </span>Es hijo de Migrante Guerrerense?:  </Combobox.Label>
        ...
        {paso3?.esHijoMigrante! === undefined &&  
