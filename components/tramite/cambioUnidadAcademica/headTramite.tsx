    ...
    return (
        <>
            ...
            <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-sm text-gray-900">{tramitesState.procedimientos.cambioUnidadAcademica?.unidadAcademica}</dd>
            </div>
            <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500">Plan de estudios</dt>
                <dd className="mt-1 text-sm text-gray-900">{tramitesState.procedimientos.cambioUnidadAcademica?.planElegido}</dd>
            </div>
