...
export const FormularioRevalidacion:FC<Props> = (props) => {
    const {tramitesState, dispatch} = useTramitesContext()
    //let {telefono, planIngresarId} = tramitesState?.procedimientos?.revalidacion!
    ...
    const onChange = ({target}:any) => {
        ...
        const nombreTramite = 'revalidacion'
