...
const steps = [
  { id: 'PASO 1', name: 'Datos generales', href: '#', status: 'current' },
  { id: 'PASO 2', name: 'Domicilio', href: '#', status: 'upcoming' },
            ...
            {step.status === 'complete' ? (
              <a href={step.href} className="group flex items-center w-full">
                <span className="px-6 py-4 flex items-center text-sm font-medium">
                  <span className="flex-shrink-0 w-16 h-10 flex items-center justify-center bg-indigo-600 rounded-full group-hover:bg-indigo-800">
