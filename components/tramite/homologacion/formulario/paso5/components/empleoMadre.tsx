...
const EmpleoMadre = () => {
    ...
    const naSelec = paso5 ? opciones?.find((op) => {
        return op.id === paso5.empleoMadreID
    }) : undefined;
    ...
    query === ''
      ...
      const handleChange = (op:TypeOpciones) => {
        ...
        const nombreCampo='empleoMadreID';
    ...
    return (
        ...
        <Combobox.Label className="block text-sm font-medium text-gray-700"><span className="mt-2 text-sm text-red-500">* </span>¿Qué tipo de empleo tiene su madre o tutora?:  </Combobox.Label>
